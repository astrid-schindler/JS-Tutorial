...
let whereIsPlus = shopping.indexOf("+++")
console.log(whereIsPlus)

// Aufgabe 3

console.log(shopping.substr(0, whereIsPlus) + shopping.substr(whereIsPlus + 3))
console.log(shopping.slice(0, whereIsPlus) + shopping.slice(whereIsPlus + 3))
